...
| Статус | I (implemented) — юниты и h2-стенд red/green; **против живого Xray НЕ проверено**, выпущено в `v1.14.1-lx.8` по слову владельца 2026-09-18 (сверка по коду §1.0; живой прогон — за репортёром issue #130) |
