...
| Статус | C (complete) — воспроизведён голым `hex.Decode`, закрыт red/green юнитами; выпущено в `v1.14.1-lx.5`, `sing-box check` на бинарнике из релиза даёт `invalid short_id` |
