...
| Статус | D (done) — код + тесты + сборка; репортёр issue #14 подтвердил связку на `lx.35` (2026-09-06, тикет закрыт 2026-09-08); в поле с `v1.14.0-lx.29` без жалоб, закрыта владельцем 2026-09-24 |
| Ветка | `lx` |
