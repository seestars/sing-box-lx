...
| Статус | D (done) — код + юниты red/green 2026-09-02; на стенде лаунчера не гонялось, в поле с `v1.14.0-lx.30` (LxBox 2.22.0, лаунчер 1.5.4) без жалоб, закрыта владельцем 2026-09-24 |
| Ветка | `lx` |
...
| сырой UDP через socks5 UDP-associate (не DNS-транспорт) | работает — настоящий NXDOMAIN от 8.8.8.8 |
...
**Что это закрывает и что нет.** Случай 072-C по записи дампа
